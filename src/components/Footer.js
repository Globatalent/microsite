      ...
      <footer className="footer" style={style.footerStyle}>
        ...
        <section style={{display: 'flex', justifyContent: 'center'}}>
          ...
          <ul className="is-flex is-size-4" style={{marginLeft:'1rem'}}>
            <li><a href="https://www.facebook.com/globatalent.official" className="icon" style={style.textColor}><FontAwesomeIcon icon={faFacebook} /></a></li>
            <li><a href="https://twitter.com/globatalent" className="icon" style={style.textColor}><FontAwesomeIcon icon={faTwitter} /></a></li>
            <li><a href="https://www.instagram.com/globatalent/" className="icon" style={style.textColor}><FontAwesomeIcon icon={faInstagram} /></a></li>
            <li><a href="https://t.me/globatalent/" className="icon " style={style.textColor}><FontAwesomeIcon icon={faTelegram} /></a></li>
            <li><a href="https://linkedin.com/company/globatalent" className="icon" style={style.textColor}><FontAwesomeIcon icon={faLinkedin} /></a></li>
          </ul>
          <br />
        </section>
